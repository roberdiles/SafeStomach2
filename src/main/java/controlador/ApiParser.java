...
public class ApiParser {
    ...
    /**
     * Crea el objeto ApiParser.
     * Éste toma los datos JSON de la API mediante ApiRequest y los introduce en un arreglo de string.
     * y posteriormente a un Arraylist de el objeto Alimento.
     */
    public ApiParser() {
        try {
    ...
    /**
     *  Método getAlimentos retorna el Arraylist con los Alimentos obtenidos de la API
     * @return
     */
